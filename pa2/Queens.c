 ...
 *    * CSE 15
 *     * 10/29/19
 * Queens is a program which provides all the solutions to the necessary amount of Queens on the board not checking each other and have n amount of Queens.
 * Queens.c 
 */
...
#include<ctype.h>
#include <stdbool.h>
// places the queen on 2d array B
...
// checks if the space on the board is available
...
// prints the solutions for printing board
...
// this is main function which makes sure the input is correct and find the soltuions
